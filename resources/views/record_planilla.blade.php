...
<div class="container">
    ...
    <form action="{{ route('consultarRecordPlanilla') }}" method="POST">
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="card card-with-title p-3 mb-4 border-2 border-dark">
                    ...
                    <span class="card-title">Buscar Record de Planilla</span>
                    <div class="row mb-4">
