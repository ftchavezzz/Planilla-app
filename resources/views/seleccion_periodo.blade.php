        ...
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="card card-with-title p-3 mb-4 border-2 border-dark">
                    ...
                    <span class="card-title">Seleccion del periodo para la generacion de una nueva planilla</span>
                    <div class="row mb-4">
                        <div>
                            <input type="text" class="form-control form-control-sm col-md-3 col-lg-2" id="id" name="id" value='0' hidden required>
                        </div>
