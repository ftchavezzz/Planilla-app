                    ...
                    <div class="card card-with-title p-3 mb-4 border-2 border-dark">
                        ...
                        <div class="row mb-4">
                            <div class="col-6 col-md-6 col-lg-6">
                                ...
                                <input type="email" class="form-control form-control-sm col-md-3 col-lg-2" id="email" placeholder="Ingresa el email del empleado" name="email">
                                @error('email')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card card-with-title p-3 mb-4 mt-5 border-2 border-dark">
                        ...
                        <div class="row mb-4">
                            <div class="col-6 col-md-6 col-lg-6">
                                ...
                                <select class="form-select form-select-sm col-md-3 col-lg-2" id="departamento" placeholder="Seleccione el departamento" name="departamento">
                            ...
                            <div class="col-6 col-md-6 col-lg-6">
                                ...
                                <select class="form-select form-select-sm col-md-3 col-lg-2" id="puesto" placeholder="Seleccione el puesto" name="puesto_id">
                        ...
                        <div class="row mb-4">
                            <div class="col-6 col-md-6 col-lg-6">
                                <label for="fecha_ingreso" class="form-label">Fecha de Inicio</label>
                                <input type="date" class="form-control form-control-sm col-md-3 col-lg-2" id="fecha_ingreso" placeholder="Ingresa la fecha que ingreso el empleado" name="fecha_ingreso" >
                                @error('fecha_ingreso')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-6 col-md-6 col-lg-6">
                                ...
                                <input type="date" class="form-control form-control-sm col-md-3 col-lg-2" id="fecha_fin" placeholder="Ingresa la fecha que ingreso el empleado" name="fecha_fin" >
                                @error('fecha_ingreso')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-6 col-md-6 col-lg-6">
                                    ...
                                    <select class="form-select form-select-sm col-md-3 col-lg-2" id="contrato" placeholder="Seleccione el departamento" name="contrato_id">
